...
function usage(catalog) {
  ...
  const lines = [
    ...
    '  --arc=<scripted|three|six>',
    '                        the shot list a direct tape is asked for: scripted',
    '                        (the place\'s own script, default), three beats (one',
    '                        continuous moment) or six (the vlog).',
